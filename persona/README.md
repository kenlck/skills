...
Role-based personas for Claude Code. Activate a specialist mindset to get focused, opinionated assistance across engineering, design, fullstack work, and testing.

## Skills

| Skill | Invoke | Description |
|-------|--------|-------------|
| `software-engineer` | `/persona:software-engineer` | Senior engineer persona: clean architecture, SOLID principles, pragmatic problem-solving |
